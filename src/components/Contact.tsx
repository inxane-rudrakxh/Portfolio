    ...
    <section className="relative z-20 bg-[#0a0a0a] py-32 px-4 md:px-12 overflow-hidden" id="contact">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <div className="flex flex-col gap-6 mb-12">
              ...
              <div className="flex items-center gap-4">
                 <SocialLink href="https://github.com/inxane-rudrakxh" icon={<GithubIcon />} label="GitHub" />
                 <SocialLink href="https://linkedin.com/in/rudraksh-kottalwar" icon={<LinkedinIcon />} label="LinkedIn" />
                 <SocialLink href="https://x.com/inxane_rudrakxh" icon={<TwitterIcon />} label="Twitter" />
              </div>
            </div>
        ...
        <footer className="mt-24 pt-8 border-t border-white/5 text-center text-gray-500 font-mono text-sm">
           <p>&copy; {new Date().getFullYear()} Rudraksh Kottalwar. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
