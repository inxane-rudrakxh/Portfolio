...
const TIMELINE_DATA = [
  {
    ...
    description: "Build many apps and tools and attended two hackathons til mow.",
    type: "work",
  },
  {
    year: "2023 - 2024",
    ...
    org: "Beast Arrives",
    description: "Finally got my laptop and started my journey as a full stack developer, building & learning tools and apps.",
    type: "milestone",
  },
  {
    year: "2023 - 2024",
    title: "Diploma in Computer Science Engineering",
    org: "Somayya Polytechnic",
    description: "Passionate about programming and software engineering.",
    type: "education",
  },
  {
    year: "2022 - 2023",
    title: "10th Class",
    org: "Grace Emmanuel, School",
    description: "Completed 10th class with a strong foundation in Geography and Languages but interested in programming.",
    type: "education",
  },
];
