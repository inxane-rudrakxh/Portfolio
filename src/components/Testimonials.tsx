...
const TESTIMONIALS = [
  {
    quote: "Built a full-stack Skill Gap Analyzer at Innovex Hackathon — users enter their skills, get AI-powered gap analysis and a personalized learning roadmap.",
    name: "Innovex Hackathon",
    role: "Project: Skill Gap Analyzer",
    initials: "IH",
  },
  {
    quote: "Designed and deployed a cinematic scrolly-telling portfolio with GSAP animations, scroll-driven video, and a fully responsive dark UI.",
    name: "Personal Project",
    role: "Portfolio Website",
    initials: "PP",
  },
  {
    quote: "Learned React, Node.js, and Firebase from scratch — building real apps along the way, not just following tutorials.",
    name: "Self-Taught Journey",
    role: "Full Stack Development",
    initials: "ST",
  },
  {
    quote: "Passionate about building tools that solve real problems — from desktop utilities to web apps that actually get used.",
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
       ...
       <div className="container mx-auto px-6 mb-16 text-center relative z-10">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                Key moments, projects, and milestones from my journey as a developer.
            </p>
        ...
        {isModalOpen && (
          <div className="absolute inset-0 z-50 flex items-center justify-center px-4 h-full">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-2 relative z-10">Share a Highlight</h3>
              <p className="text-gray-400 mb-6 relative z-10">Collaborated with me? Share a project moment or experience!</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-1">Highlight / Experience</label>
                  <textarea
                    required
                    rows={4}
